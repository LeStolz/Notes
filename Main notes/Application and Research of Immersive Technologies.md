...
> [[Virtual Reality]] is a generic technology: Can be used anywhere we need a graphical simulation (17%) to simulate better to be better used for training, teaching (16%), understanding, designing, managing, entertaining (21%), communicating (11%), controlling,...
...
# Domains
- Health:
	- Training by simulation (surgeon, dentist training with force feedback, medical situations, overlaying physiological data or needle paths on a patient to guide procedures).
...
- Industry:
	...
	- Remote operating.
- Daily:
	- Show info of real objects based on context.
# Metaverse
